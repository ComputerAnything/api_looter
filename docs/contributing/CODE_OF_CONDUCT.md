...
api_looter is an educational project designed to help beginners learn about APIs.
...
aggression toward individuals or classes of individuals.
...
[SECURITY.md](SECURITY.md). Do not create public issues for security problems.
